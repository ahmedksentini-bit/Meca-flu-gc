const CACHE = "mecaflu-v2-7";
const ASSETS = ["./","./index.html","./styles.css","./enhancements.css","./src/app.js","./src/solvers.js","./data/exercises.json","./data/exercises-ch1-ch2.json","./manifest.webmanifest","./assets/icon.svg"];
