...
function chapterPage(chapterId) {
  ...
  const order = {
    properties: ["PROP_DENSITY_01", "PROP_COMPRESS_01", "PROP_VISC_01", "PROP_VISCOMETER_02", "PROP_CAPILLARY_03", "PROP_LAPLACE_04", "PROP_GAS_05"],
    hydrostatics: ["HYDRO_LAYERS_01", "HYDRO_MANO_01", "HYDRO_PRESS_03", "FORCE_GATE_02", "FORCE_PLANE_01", "HYDRO_INCLINED_06", "HYDRO_CURVED_07", "HYDRO_ARCHIMEDE_08", "HYDRO_STABILITY_04"],
    forces: ["FORCE_GATE_02", "FORCE_PLANE_01", "HYDRO_INCLINED_06", "HYDRO_CURVED_07"]
  };
  let exercises;
