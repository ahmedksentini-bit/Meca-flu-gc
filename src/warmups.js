export const warmups = {
  ...
  HG_S1_01: [{ prompt: "p_A est négative, p_F = 0, A est au-dessus de F. La masse volumique de B est…", choices: [{ id: "pos", label: "positive : ρ_B = −p_A/(g h)" }, { id: "neg", label: "négative, comme p_A" }, { id: "atm", label: "égale à celle de l’air" }], correct: "pos", explain: "En descendant de h, la pression augmente de ρgh. Pour remonter de p_A < 0 jusqu’à 0, il faut ρ_B = −p_A/(gh) > 0." }],
  HG_S1_02: [{ prompt: "Les deux branches du U sont à l’atmosphère. L’équilibre porte sur…", choices: [{ id: "rhoz", label: "les colonnes ρZ des deux côtés" }, { id: "vol", label: "l’égalité des volumes d’huile et d’eau" }, { id: "zonly", label: "Z₁ = Z₄ seulement" }], correct: "rhoz", explain: "p = 0 aux deux surfaces. En cheminant, ΣρgΔz = 0, donc les ρZ se compensent. Les longueurs seules ne suffisent pas." }],
  HG_S1_03: [{ prompt: "La vitesse en sortie de tuyère, fluide parfait, dépend surtout…", choices: [{ id: "all", label: "de toute la chute plan d’eau → tuyère" }, { id: "pipe", label: "seulement de z₁ − z₂ dans la conduite" }, { id: "s", label: "uniquement de la section S" }], correct: "all", explain: "Torricelli : V = √(2g Δz) entre surface libre et jet à l’air. La conduite accélère peu (grande S) ; la tuyère voit les 400 m." }],
  HG_S1_04: [{ prompt: "Au col du Venturi, par rapport à l’amont…", choices: [{ id: "vup", label: "V augmente et p diminue" }, { id: "both", label: "V et p augmentent" }, { id: "p", label: "p augmente (Bernoulli « inverse »)" }], correct: "vup", explain: "S₂ < S₁ ⇒ V₂ > V₁. Bernoulli : l’énergie cinétique se paie en pression. Le mercure monte du côté col." }],
  HG_S2_01: [{ prompt: "On donne Re, pas Q. La vitesse se déduit par…", choices: [{ id: "re", label: "V = Re ν / D" }, { id: "tor", label: "V = √(2gL)" }, { id: "q", label: "il manque Q, on ne peut pas" }], correct: "re", explain: "Re = VD/ν est la définition. ν à 40 °C n’est pas 10⁻⁶. Ensuite Moody / Colebrook donne λ(Re, ε/D)." }],
  HG_S2_02: [{ prompt: "Un élargissement conique à 30°, comparé à un élargissement brusque…", choices: [{ id: "less", label: "dissipe moins (K plus petit que Borda)" }, { id: "more", label: "dissipe plus, le cône « casse » le jet" }, { id: "same", label: "a le même K que Borda" }], correct: "less", explain: "Borda suppose un décollement franc. Un cône modéré guide l’écoulement : K de Crane est une fraction de (1−A₁/A₂)²." }],
  HG_S2_03: [{ prompt: "Le tronçon de plus petit diamètre, à Q égal, produit une perte linéaire…", choices: [{ id: "big", label: "beaucoup plus grande (V² et 1/D)" }, { id: "small", label: "plus petite : moins de paroi" }, { id: "eq", label: "égale, λ étant le même" }], correct: "big", explain: "V ∝ 1/D² donc V²/D ∝ 1/D⁵. Le col CD domine presque toujours h_f." }],
  HG_S2_04: [{ prompt: "Hazen–Williams, comparé à Colebrook…", choices: [{ id: "emp", label: "est empirique, avec un C de paroi, sans Re" }, { id: "same", label: "est identique : C = 1/λ" }, { id: "lam", label: "ne vaut que si l’écoulement est laminaire" }], correct: "emp", explain: "C caractérise le matériau (neuf / usé). Il n’y a pas de Reynolds dans la formule. C’est l’outil classique d’AEP, pas le Moody." }],
  HG_S2_05: [{ prompt: "Conduite horizontale sans machine : p_B par rapport à p_A…", choices: [{ id: "down", label: "diminue de ρg h_f" }, { id: "up", label: "augmente, l’eau « pousse »" }, { id: "eq", label: "reste égale (Bernoulli parfait)" }], correct: "down", explain: "Sans dénivelée ni pompe, toute l’énergie perdue au frottement se traduit en chute de pression." }],
  HG_S3_01: [{ prompt: "Deux conduites en parallèle entre A et C ont…", choices: [{ id: "dh", label: "la même perte de charge, pas le même débit" }, { id: "q", label: "le même débit, quels que soient D et L" }, { id: "j", label: "la même pente J, donc Q ∝ L" }], correct: "dh", explain: "Les nœuds A et C imposent le même ΔH. Les Q s’ajustent selon L, D et C de chaque branche." }],
  HG_S3_02: [{ prompt: "Dans le tronçon de 15 cm, la ligne piézométrique est…", choices: [{ id: "low", label: "nettement sous l’EGL (V²/2g grand)" }, { id: "on", label: "confondue avec l’EGL" }, { id: "above", label: "au-dessus de l’EGL" }], correct: "low", explain: "HGL = EGL − V²/2g. V₁₅ ≈ 4 V₃₀ donc la hauteur cinétique explose dans le col : HGL plonge." }],
  HG_S4_01: [{ prompt: "Chézy V = C √(R i) et Manning V = (1/n) R^{2/3} √S…", choices: [{ id: "diff", label: "ne sont pas la même formule : C n’est pas 1/n" }, { id: "eq", label: "sont identiques si C = 1/n" }, { id: "c", label: "Chézy ne sert que pour les pipes" }], correct: "diff", explain: "Manning a R^{2/3}, Chézy R^{1/2}. C ≈ Kₛ R^{1/6}, donc C varie un peu avec y. On ne remplace pas n par 1/C." }],
  HG_S4_02: [{ prompt: "Une pente 1/12 sur un triangle lisse donne en général…", choices: [{ id: "sup", label: "un régime torrentiel (y_n < y_c)" }, { id: "sub", label: "un régime fluvial" }, { id: "crit", label: "exactement le critique" }], correct: "sup", explain: "i = 8 % est très fort pour un canal : y_n petit, V grande, Fr ≫ 1. Le second bief plus doux redevient fluvial." }],
  HG_S5_01: [{ prompt: "En fluvial, un seuil de fond fait en général…", choices: [{ id: "down", label: "baisser le tirant (on se rapproche de y_c)" }, { id: "up", label: "augmenter y comme un barrage" }, { id: "z", label: "baisser y exactement de z" }], correct: "down", explain: "E₂ = E₁ − z. Sur la branche fluviale de E(y), diminuer E diminue y. Ce n’est pas y₁ − z : l’énergie cinétique change." }],
  HG_S5_02: [{ prompt: "La bonne racine de E(y) = E₂ en amont fluvial est…", choices: [{ id: "fl", label: "la racine y > y_c (fluviale)" }, { id: "to", label: "toujours la plus petite (torentielle)" }, { id: "yc", label: "y_c, le seuil forçant le critique" }], correct: "fl", explain: "Sans contrôle critique, le régime ne saute pas tout seul. On reste fluvial tant que E₂ > E_c. y_c seulement si le seuil noie." }],
  HG_S5_03: [{ prompt: "Pente forte puis pente faible, même b : on attend souvent…", choices: [{ id: "jump", label: "un ressaut entre les deux y_n" }, { id: "drop", label: "une chute critique obligatoire" }, { id: "same", label: "le même y, Q étant constant" }], correct: "jump", explain: "y_n torrentiel puis y_n fluvial : le raccord se fait par ressaut (conjuguées). y n’est pas constant : i a changé." }],
  HG_S5_04: [{ prompt: "Un ressaut classique n’existe que si l’amont est…", choices: [{ id: "sup", label: "torrentiel : Fr₁ > 1" }, { id: "sub", label: "fluvial : Fr₁ < 1" }, { id: "any", label: "indifférent" }], correct: "sup", explain: "Le ressaut raccorde un torrentiel à un fluvial. Fr₁ = 20/√(g×1,5) ≫ 1 ici : y₂ sera beaucoup plus grand que y₁." }]
};
